...
let Service, Characteristic, Accessory, UUIDGen, DailySensor, DailyGroup, DailySocket;
...
module.exports = function(service, characteristic, accessory, uuidGen, dailySensor, dailyGroup, dailySocket){
    Service = service;
