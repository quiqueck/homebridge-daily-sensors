...
class DailyPlatform {
    constructor(log, config, api) {
        ...
        this.ble = require('./ble.js')({info:log, debug:this.debug?log:function(){}}, this.btDevices, this.btEvent.bind(this));
    ...
    btEvent(e){
        ...
        if (e!==undefined && e.id !== undefined){
            this.accessories
                .filter(sensor => sensor.btSwitch === e.id)
    ...
    addAccessory(inConfig) {
        ...
        this.log("Add Accessory", accessoryName, inConfig);
